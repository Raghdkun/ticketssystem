...
export function EventCard({
    ...
    return (
        // A faint orange light follows the pointer across the card. Pointer
        // events only, so a touch screen sees a plain card.
        <SpotlightCard
            spotlightColor="rgba(246, 96, 2, 0.14)"
            className={cn(
                'h-full rounded-xl border bg-card transition',
                ended && 'opacity-70',
            )}
        >
            <Link
